...
class CDAMGenFiles:
	...
	def GenerateHeader(self, language, title, subtitle, author, credits, contact, binVer, storyVer, storySize, variableCount):
		...
		print  "UUID: " + str(storyUuid.hex)
		data += storyUuid.bytes_le
		...
		data += chr(flagOne)
		# Continue - Multiplayer - Hide Used - Rsvd x 5
		# 0x80       0x40          0x20        0x10 - 0x00
